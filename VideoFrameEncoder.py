...
if __name__ == "__main__":
    ...
    input_video_path = "1.mp4"  # 输入视频路径
    output_video_path = "output.mp4"  # 输出视频路径 
    encoder.encode_video(input_video_path, output_video_path, codec='h264')
    successful_frames, total_frames = encoder.verify_video(output_video_path, sample_frames=5, random_sampling=True)
    print(f"验证结果: 成功解码 {successful_frames} 帧，总共验证 {total_frames} 帧")