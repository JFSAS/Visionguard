...
def main():
    tokenizer = XLMRobertaTokenizer("/root/autodl-tmp/model_zoo/ALVG/weights/beit3.spm")
    expression = 'The man in the speckled black suit.'
    ...
    model = model.cuda()
    load_checkpoint(model, None, load_from="/root/autodl-tmp/model_zoo/ALVG/weights/det_best2.pth")
