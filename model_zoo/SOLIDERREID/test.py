...
# 设置参数值
args.config_file = "/root/autodl-tmp/model_zoo/SOLIDERREID/configs/msmt17/swin_small.yml"
args.opts = [
    "TEST.WEIGHT", "/root/autodl-tmp/model_zoo/weights/swin_small_market.pth",
...
model = make_model(cfg, num_class=751, camera_num=0, view_num = 0, semantic_weight = cfg.MODEL.SEMANTIC_WEIGHT)
if cfg.TEST.WEIGHT != '':
...
def normalize_image(image_tensor):
    ...
    mean_tensor = mean.view(1, 3, 1, 1).to('cuda')
    std_tensor = std.view(1, 3, 1, 1).to('cuda')
